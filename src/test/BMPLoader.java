...
public class BMPLoader {
        ...
        /*for (int i = minx; i < width; i++) {
            for (int j = miny; j < height; j++) {
                ...
                System.out.println("i="+String.valueOf(i)+",j="+String.valueOf(j)
                              +",detail="+list[i][j]
                              + ",sum=" 
                      		+ Integer.valueOf(Integer.valueOf(rgb[0])
                            		+ Integer.valueOf(rgb[1])
                            		+ Integer.valueOf(rgb[2])));
                if (Integer.valueOf(Integer.valueOf(rgb[0])
                            		+ Integer.valueOf(rgb[1])
                            		+ Integer.valueOf(rgb[2]))>60){
                	System.out.println(i);
                	System.out.println(j);
                	return null;
                }
                
                //String[] value = list[i][j].toString().split(",");
                //System.out.println("i="+String.valueOf(i)+"j="+String.valueOf(j) + "="+Math.abs(Integer.parseInt(value[0])));
            }
        }*/
    ...
    public static void main(String[] args){
        BMPLoader.compareImage("D:\\test\\sfz.jpg", "D:\\test\\sfz.jpg");
    }
}