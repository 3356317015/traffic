...
import com.jasper.designer.IReportViewerListener;
...
public class ZoomComboContributionItem extends ContributionItem implements
	...
	private Control createControl(Composite parent) {
		combo = new CCombo(parent, SWT.BORDER|SWT.DROP_DOWN);
		combo.addListener(SWT.Selection, this);
		combo.addListener(SWT.DefaultSelection, this);
	...
	/**
	 * @see com.jasper.designer.IReportViewerListener#viewerStateChanged(com.jasper.designer.ReportViewerEvent)
	 */
