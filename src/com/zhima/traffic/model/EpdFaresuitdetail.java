...
@TableTag(cName="基础套价表",eName="EpdFaresuitdetail",tabName="epd_faresuitdetail")
public class EpdFaresuitdetail implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	
	@FieldTag(cName="价套票价序号",eName="faresuitdetailSeq",field="faresuitdetail_seq",pk=true)
	private String faresuitdetailSeq="";
	
	@FieldTag(cName="价套序号",eName="faresuitSeq",field="faresuit_seq")
	...
	@FieldTag(cName="",eName="updateTime",field="update_time")
	private String updateTime="";
	
	@FieldTag(cName = "价套名称", eName = "faresuitName", field = "faresuit_name", db = false)
	...
	/** default constructor */
	public EpdFaresuitdetail() {
	}
	/** full constructor */

	// Property accessors

	public String getFaresuitdetailSeq() {
		return faresuitdetailSeq;
	}
	
	
	public void setFaresuitdetailSeq(String faresuitdetailSeq) {
		this.faresuitdetailSeq = faresuitdetailSeq;
	}
