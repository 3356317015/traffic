...
@TableTag(cName="票据类型",eName="EpdTickettype",tabName="epd_tickettype")
public class EpdTickettype implements java.io.Serializable {
	...
	@FieldTag(cName="票据类型",eName="category",field="category")
