...
public interface IItsLinerfare {
	...
	public void delete(List<ItsLinerfare> itsLinerfare,Map<String, Object> config) throws UserBusinessException;
	...
	public void updateAttribute(List<ItsLinerfare> itsLinerfares,Map<String, Object> config) throws UserBusinessException;
