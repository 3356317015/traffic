...
public interface IVmsSound {
	

	public List<VmsSound> inserts(List<VmsSound> vmsSounds, Map<String, Object> config) throws UserBusinessException;
	
	public void update(VmsSound vmsSound, Map<String, Object> initConfig) throws UserBusinessException;
	
	public void delete(List<VmsSound> vmsSounds,Map<String, Object> config)
