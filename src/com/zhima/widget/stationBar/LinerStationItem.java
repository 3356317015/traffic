...
public class LinerStationItem extends Composite {
	//正确的图形
	...
	public LinerStationItem(Composite parent,int index,Station station) {
	...
	private void createContent(){
		...
		Text txtStationName = new Text(this, SWT.BORDER|SWT.CENTER|SWT.READ_ONLY);
		...
		lbIfSale.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
		...
		final Text txtTicketNum = new Text(this, SWT.BORDER|SWT.CENTER|SWT.READ_ONLY);
		//txtTicketNum.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
		//txtStationNum.setForeground(SWTResourceManager.getColor(SWT.COLOR_YELLOW));
		txtTicketNum.setToolTipText("已售数");
		txtTicketNum.setFont(SWTResourceManager.getFont("微软雅黑", 9, SWT.NORMAL));
		txtTicketNum.setEnabled(false);
		formData = new FormData();
		formData.top = new FormAttachment(0,2);
		formData.left = new FormAttachment(txtStationNum,5);
		formData.bottom = new FormAttachment(100,-2);
		formData.width = 60;
		txtTicketNum.setLayoutData(formData);
		
		final Text txtCheckNum = new Text(this, SWT.BORDER|SWT.CENTER|SWT.READ_ONLY);
		//txtCheckNum.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
		//txtStationNum.setForeground(SWTResourceManager.getColor(SWT.COLOR_YELLOW));
		txtCheckNum.setToolTipText("检票数");
		txtCheckNum.setFont(SWTResourceManager.getFont("微软雅黑", 9, SWT.NORMAL));
		txtCheckNum.setEnabled(false);
		formData = new FormData();
		formData.top = new FormAttachment(0,2);
		formData.left = new FormAttachment(txtTicketNum,5);
		formData.bottom = new FormAttachment(100,-2);
		formData.width = 60;
		txtCheckNum.setLayoutData(formData);
		
		Text txtStationMileage = new Text(this, SWT.BORDER|SWT.CENTER|SWT.READ_ONLY);
		txtStationMileage.setToolTipText("里程");
		//lbStationName.setBackground(SWTResourceManager.getColor(SWT.COLOR_BLUE));
		txtStationMileage.setFont(SWTResourceManager.getFont("微软雅黑", 9, SWT.NORMAL));
		txtStationMileage.setEnabled(false);
		formData = new FormData();
		formData.top = new FormAttachment(0,2);
		formData.left = new FormAttachment(txtCheckNum,5);
		formData.bottom = new FormAttachment(100,-2);
		formData.width =80;
		txtStationMileage.setLayoutData(formData);
		...
		if (null != station){
			...
			if(null != station.getStationMileage()){
			...
			txtTicketNum.setText(String.valueOf(station.getTicketNum()));
			txtCheckNum.setText(String.valueOf(station.getCheckNum()));
		}
	}
