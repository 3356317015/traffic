...
/**
* 可设置背景图片的Composite
* Composite本身是可以设置背景图片的，但是只提供了平铺的显示方式，
* 该类实现了居中、平铺和拉伸三种显示方式。
* @author 003
*/
public class ImageView extends Composite implements PaintListener{
	/**
	* 居中
	*/
	...
	*/
	public ImageView(Composite parent, int style, Image image, String modeName){
		super(parent, style);
