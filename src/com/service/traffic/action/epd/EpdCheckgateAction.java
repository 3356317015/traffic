...
public class EpdCheckgateAction {
	...
	public String insert(String security,String parameter) {
		...
		try {
	        ...
	        EpdCheckgate epdCheckgate =(EpdCheckgate)JsonUtil.convertObject(
	        		mapParameter.get("epdCheckgate").toString(),EpdCheckgate.class);
	        ...
	        //3.调用业务
			EpdCheckgate newEpdCheckgate = iNetEpdCheckgate.insert(epdCheckgate, mapConfig);
	        result.put("epdCheckgate", JSONObject.fromObject(newEpdCheckgate).toString());
	...
	public String update(String security,String parameter) {
		...
		try {
			...
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetEpdCheckgate.update(epdCheckgate, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String delete(String security,String parameter) {
		...
		try {
			...
			List<EpdCheckgate> epdCheckgates = (List<EpdCheckgate>)JsonUtil.convertArray(
			...
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetEpdCheckgate.delete(epdCheckgates, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryByPK(String security,String parameter) {
		...
		try {
	        ...
	        JSONObject jsonParameter = JSONObject.fromObject(strParameter);
	        Map mapParameter = (Map)jsonParameter;
	        String checkgateSeq = String.valueOf(mapParameter.get("checkgateSeq"));
	        //3.调用业务
			List<EpdCheckgate> epdCheckgates = iNetEpdCheckgate.queryByPK(checkgateSeq);
			JSONArray jsonarray = JSONArray.fromObject(epdCheckgates);
			result.put("epdCheckgates", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryByAll(String security) {
		...
		try {
			...
			//2.解析parameter
	        //3.调用业务
			List<EpdCheckgate> epdCheckgates = iNetEpdCheckgate.queryByAll();
			JSONArray jsonarray = JSONArray.fromObject(epdCheckgates);
			result.put("epdCheckgates", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryPageByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String checkCode = String.valueOf(mapParameter.get("checkCode"));
	        String checkName = String.valueOf(mapParameter.get("checkName"));
	        int start = Integer.valueOf(mapParameter.get("start").toString());
	        int limit = Integer.valueOf(mapParameter.get("limit").toString());
	        //3.调用业务
			List<EpdCheckgate> epdCheckgates = iNetEpdCheckgate.queryPageByCustom(organizeSeq,
	...
	public String queryAllByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String checkName = String.valueOf(mapParameter.get("checkName"));
	        //3.调用业务
			List<EpdCheckgate> epdCheckgates = iNetEpdCheckgate.queryAllByCustom(organizeSeq,
					checkCode, checkName);
			JSONArray jsonarray = JSONArray.fromObject(epdCheckgates);
			result.put("epdCheckgates", jsonarray.toString());
		} catch (UserBusinessException e) {
	...
	public String queryCountByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String checkName = String.valueOf(mapParameter.get("checkName"));
	        //3.调用业务
			int count = iNetEpdCheckgate.queryCountByCustom(organizeSeq, checkCode, checkName);
	...
	public String queryByOrganizeSeq(String security,String parameter) {
		...
		try {
	        ...
	        String organizeSeq = String.valueOf(mapParameter.get("organizeSeq"));
	        //3.调用业务
			List<EpdCheckgate> epdCheckgates = iNetEpdCheckgate.queryByOrganizeSeq(organizeSeq);
			JSONArray jsonarray = JSONArray.fromObject(epdCheckgates);
			result.put("epdCheckgates", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
