...
public class EpdContractAction {
	...
	public String insert(String security,String parameter) {
		...
		try {
	        ...
	        EpdContract epdContract =(EpdContract)JsonUtil.convertObject(
	        		mapParameter.get("epdContract").toString(),EpdContract.class);
	        ...
	        //3.调用业务
			EpdContract newEpdContract = iNetEpdContract.insert(epdContract, mapConfig);
	        result.put("epdContract", JSONObject.fromObject(newEpdContract).toString());
	...
	public String update(String security,String parameter) {
		...
		try {
			...
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetEpdContract.update(epdContract, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String delete(String security,String parameter) {
		...
		try {
			...
			List<EpdContract> epdContracts = (List<EpdContract>)JsonUtil.convertArray(
					mapParameter.get("epdContracts").toString(), new EpdContract());

	        String strConfig = JSONObject.fromObject(mapParameter.get("config").toString()).toString();
			JSONObject jsonConfig = JSONObject.fromObject(strConfig);
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetEpdContract.delete(epdContracts, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryByPK(String security,String parameter) {
		...
		try {
	        ...
	        //3.调用业务
			List<EpdContract> epdContracts = iNetEpdContract.queryByPK(contractSeq);
			JSONArray jsonarray = JSONArray.fromObject(epdContracts);
			result.put("epdContracts", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryByAll(String security) {
		...
		try {
			...
			//2.解析parameter
	        //3.调用业务
			List<EpdContract> epdContracts = iNetEpdContract.queryByAll();
			JSONArray jsonarray = JSONArray.fromObject(epdContracts);
			result.put("epdContracts", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryByOrganizeSeq(String security,String parameter) {
		...
		try {
	        ...
	        //3.调用业务
			List<EpdContract> epdContracts = iNetEpdContract.queryByOrganizeSeq(organizeSeq);
			JSONArray jsonarray = JSONArray.fromObject(epdContracts);
			result.put("epdContracts", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
