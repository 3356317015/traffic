...
public class EpdParkingAction {
	...
	public String insert(String security,String parameter) {
		...
		try {
	        ...
	        EpdParking epdParking =(EpdParking)JsonUtil.convertObject(
	        		mapParameter.get("epdParking").toString(),EpdParking.class);
	        ...
	        //3.调用业务
			EpdParking newEpdParking = iNetEpdParking.insert(epdParking, mapConfig);
	        result.put("epdParking", JSONObject.fromObject(newEpdParking).toString());
	...
	public String update(String security,String parameter) {
		...
		try {
			...
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetEpdParking.update(epdParking, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String delete(String security,String parameter) {
		...
		try {
			...
			List<EpdParking> epdParkings = (List<EpdParking>)JsonUtil.convertArray(
					mapParameter.get("epdParkings").toString(), new EpdParking());
	        
	        String strConfig = JSONObject.fromObject(mapParameter.get("config").toString()).toString();
			JSONObject jsonConfig = JSONObject.fromObject(strConfig);
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetEpdParking.delete(epdParkings, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryByPK(String security,String parameter) {
		...
		try {
	        ...
	        JSONObject jsonParameter = JSONObject.fromObject(strParameter);
	        Map mapParameter = (Map)jsonParameter;
	        String parkingSeq = String.valueOf(mapParameter.get("parkingSeq"));
	        //3.调用业务
			List<EpdParking> epdParkings = iNetEpdParking.queryByPK(parkingSeq);
			JSONArray jsonarray = JSONArray.fromObject(epdParkings);
			result.put("epdParkings", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryByAll(String security) {
		...
		try {
			...
			//2.解析parameter
	        //3.调用业务
			List<EpdParking> epdParkings = iNetEpdParking.queryByAll();
			JSONArray jsonarray = JSONArray.fromObject(epdParkings);
			result.put("epdParkings", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryPageByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String parkingCode = String.valueOf(mapParameter.get("parkingCode"));
	        String parkingName = String.valueOf(mapParameter.get("parkingName"));
	        int start = Integer.valueOf(mapParameter.get("start").toString());
	        int limit = Integer.valueOf(mapParameter.get("limit").toString());
	        //3.调用业务
			List<EpdParking> epdParkings = iNetEpdParking.queryPageByCustom(organizeSeq,
					parkingCode, parkingName, start, limit);
			JSONArray jsonarray = JSONArray.fromObject(epdParkings);
			result.put("epdParkings", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryAllByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String parkingName = String.valueOf(mapParameter.get("parkingName"));
	        //3.调用业务
			List<EpdParking> epdParkings = iNetEpdParking.queryAllByCustom(organizeSeq,
					parkingCode, parkingName);
			JSONArray jsonarray = JSONArray.fromObject(epdParkings);
			result.put("epdParkings", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryCountByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String parkingName = String.valueOf(mapParameter.get("parkingName"));
	        //3.调用业务
			int count = iNetEpdParking.queryCountByCustom(organizeSeq, parkingCode, parkingName);
	...
	public String queryByOrganizeSeq(String security,String parameter) {
		...
		try {
	        ...
	        String organizeSeq = String.valueOf(mapParameter.get("organizeSeq"));
	        //3.调用业务
			List<EpdParking> epdParkings = iNetEpdParking.queryByOrganizeSeq(organizeSeq);
			JSONArray jsonarray = JSONArray.fromObject(epdParkings);
			result.put("epdParkings", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public String queryByOrganizeAndCheckSeq(String security,String parameter) {
		Map<String, String> result = new HashMap<String, String>();
		result.put("ResultCode", "0");
		result.put("Message", "操作成功");
		try {
	        ...
	        //3.调用业务
			List<EpdParking> epdParkings = iNetEpdParking.queryByOrganizeAndCheckSeq(organizeSeq, checkgates);
			JSONArray jsonarray = JSONArray.fromObject(epdParkings);
			result.put("epdParkings", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
