...
public class EpdCarinfoAction {
	...
	public String queryByCarSeq(String security,String parameter) {
		...
		try {
	        ...
	        //3.调用业务
			List<EpdCarinfo> epdCarinfos = iNetEpdCarinfo.queryByCarSeq(carSeq);
			JSONArray jsonarray = JSONArray.fromObject(epdCarinfos);
			result.put("epdCarinfos", jsonarray.toString());
