...
public class EpdCargradeAction {
	...
	public String insert(String security,String parameter) {
		...
		try {
	        ...
	        EpdCargrade epdCargrade =(EpdCargrade)JsonUtil.convertObject(
	        		mapParameter.get("epdCargrade").toString(), EpdCargrade.class);
	        ...
	        //3.调用业务
			EpdCargrade newEpdCargrade = iNetEpdCargrade.insert(epdCargrade, mapConfig);
	        result.put("epdCargrade", JSONObject.fromObject(newEpdCargrade).toString());
	...
	public String update(String security,String parameter) {
		...
		try {
			...
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetEpdCargrade.update(epdCargrade, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String delete(String security,String parameter) {
		...
		try {
			...
			List<EpdCargrade> epdCargrades = (List<EpdCargrade>)JsonUtil.convertArray(
					mapParameter.get("epdCargrades").toString(), new JsonConfig());

	        String strConfig = JSONObject.fromObject(mapParameter.get("config").toString()).toString();
			JSONObject jsonConfig = JSONObject.fromObject(strConfig);
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetEpdCargrade.delete(epdCargrades, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryByPK(String security,String parameter) {
		...
		try {
	        ...
	        //3.调用业务
			List<EpdCargrade> epdCargrades = iNetEpdCargrade.queryByPK(cargradeSeq);
			JSONArray jsonarray = JSONArray.fromObject(epdCargrades);
			result.put("epdCargrades", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryByAll(String security) {
		...
		try {
			...
			//2.解析parameter
	        //3.调用业务
			List<EpdCargrade> epdCargrades = iNetEpdCargrade.queryByAll();
			JSONArray jsonarray = JSONArray.fromObject(epdCargrades);
			result.put("epdCargrades", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryByOrganizeSeq(String security,String parameter) {
		...
		try {
	        ...
	        //3.调用业务
			List<EpdCargrade> epdCargrades = iNetEpdCargrade.queryByOrganizeSeq(organizeSeq);
			JSONArray jsonarray = JSONArray.fromObject(epdCargrades);
			result.put("epdCargrades", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryPageByCustom(String security,String parameter) {
		...
		try {
	        ...
	        Map mapParameter = (Map)jsonParameter;
	        String organizeSeq = String.valueOf(mapParameter.get("organizeSeq"));
	        String cargradeCode = String.valueOf(mapParameter.get("cargradeCode"));
	        String cargradeName = String.valueOf(mapParameter.get("cargradeName"));
	        int start = Integer.valueOf(mapParameter.get("start").toString());
	        int limit = Integer.valueOf(mapParameter.get("limit").toString());
	        //3.调用业务
			List<EpdCargrade> epdCargrades = iNetEpdCargrade.queryPageByCustom(organizeSeq, cargradeCode, cargradeName, start, limit);
			JSONArray jsonarray = JSONArray.fromObject(epdCargrades);
			result.put("epdCargrades", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryAllByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String cargradeName = String.valueOf(mapParameter.get("cargradeName"));
	        //3.调用业务
			List<EpdCargrade> epdCargrades = iNetEpdCargrade.queryAllByCustom(organizeSeq, cargradeCode, cargradeName);
			JSONArray jsonarray = JSONArray.fromObject(epdCargrades);
			result.put("epdCargrades", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryCountByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String cargradeName = String.valueOf(mapParameter.get("cargradeName"));
	        //3.调用业务
			int count = iNetEpdCargrade.queryCountByCustom(organizeSeq, cargradeCode, cargradeName);
	...
	public String queryByRouteSeq(String security,String parameter) {
		...
		try {
	        ...
	        //3.调用业务
			List<EpdCargrade> epdCargrades = iNetEpdCargrade.queryByRouteSeq(routeSeq);
			JSONArray jsonarray = JSONArray.fromObject(epdCargrades);
			result.put("epdCargrades", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
