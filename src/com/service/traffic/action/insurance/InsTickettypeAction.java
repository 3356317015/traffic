...
public class InsTickettypeAction {
	...
	public String insert(String security,String parameter) {
		...
		try {
	        ...
	        InsTickettype insTickettype =(InsTickettype)JsonUtil.convertObject(
	        		mapParameter.get("insTickettype").toString(), InsTickettype.class);
	        ...
	        //3.调用业务
			InsTickettype newInsTickettype = iNetInsTickettype.insert(insTickettype, mapConfig);
	        result.put("insTickettype", JSONObject.fromObject(newInsTickettype).toString());
	...
	public String update(String security,String parameter) {
		...
		try {
			...
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetInsTickettype.update(insTickettype, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String delete(String security,String parameter) {
		...
		try {
			...
			List<InsTickettype> insTickettypes = (List<InsTickettype>)JsonUtil.convertArray(
					mapParameter.get("insTickettypes").toString(), new JsonConfig());

	        String strConfig = JSONObject.fromObject(mapParameter.get("config").toString()).toString();
			JSONObject jsonConfig = JSONObject.fromObject(strConfig);
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetInsTickettype.delete(insTickettypes, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryByPK(String security,String parameter) {
		...
		try {
	        ...
	        //3.调用业务
			List<InsTickettype> insTickettypes = iNetInsTickettype.queryByPK(tickettypeSeq);
			JSONArray jsonarray = JSONArray.fromObject(insTickettypes);
			result.put("insTickettypes", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryByOrganizeSeq(String security,String parameter) {
		...
		try {
	        ...
	        //3.调用业务
			List<InsTickettype> insTickettypes = iNetInsTickettype.queryByOrganizeSeq(organizeSeq);
			JSONArray jsonarray = JSONArray.fromObject(insTickettypes);
			result.put("insTickettypes", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryPageByCustom(String security,String parameter) {
		...
		try {
	        ...
	        //3.调用业务
			List<InsTickettype> insTickettypes = iNetInsTickettype.queryPageByCustom(organizeSeq, companySeq, start, limit);
			JSONArray jsonarray = JSONArray.fromObject(insTickettypes);
			result.put("insTickettypes", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryAllByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String companySeq = String.valueOf(mapParameter.get("companySeq"));
	        //3.调用业务
	        List<InsTickettype> insTickettypes = iNetInsTickettype.queryAllByCustom(organizeSeq, companySeq);
			JSONArray jsonarray = JSONArray.fromObject(insTickettypes);
			result.put("insTickettypes", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryCountByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String companySeq = String.valueOf(mapParameter.get("companySeq"));
	        //3.调用业务
			int count = iNetInsTickettype.queryCountByCustom(organizeSeq, companySeq);
