...
public class InsCompanyAction {
	...
	public String insert(String security,String parameter) {
		...
		try {
	        ...
	        InsCompany insCompany =(InsCompany)JsonUtil.convertObject(
	        		mapParameter.get("insCompany").toString(),InsCompany.class);
	        ...
	        //3.调用业务
			InsCompany newInsCompany = iNetInsCompany.insert(insCompany, mapConfig);
	        result.put("insCompany", JSONObject.fromObject(newInsCompany).toString());
	...
	public String update(String security,String parameter) {
		...
		try {
			...
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetInsCompany.insert(insCompany, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String delete(String security,String parameter) {
		...
		try {
			...
			List<InsCompany> insCompanies = (List<InsCompany>)JsonUtil.convertArray(
					mapParameter.get("insCompanies").toString(), new InsCompany());

	        String strConfig = JSONObject.fromObject(mapParameter.get("config").toString()).toString();
			JSONObject jsonConfig = JSONObject.fromObject(strConfig);
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetInsCompany.delete(insCompanies, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryPageByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String insuranceCode = String.valueOf(mapParameter.get("insuranceCode"));
	        String insuranceName = String.valueOf(mapParameter.get("insuranceName"));
	        ...
	        //3.调用业务
			List<InsCompany> insCompanies = iNetInsCompany.queryPageByCustom(
					organizeSeq, insuranceCode, insuranceName, companyType, industry, start, limit);
			JSONArray jsonarray = JSONArray.fromObject(insCompanies);
			result.put("insCompanies", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryAllByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String industry = String.valueOf(mapParameter.get("industry"));
	        //3.调用业务
			List<InsCompany> insCompanies = iNetInsCompany.queryAllByCustom(
					organizeSeq, insuranceCode, insuranceName, companyType, industry);
			JSONArray jsonarray = JSONArray.fromObject(insCompanies);
			result.put("insCompanies", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryCountByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String industry = String.valueOf(mapParameter.get("industry"));
	        //3.调用业务
			int count = iNetInsCompany.queryCountByCustom(
					organizeSeq, insuranceCode, insuranceName, companyType, industry);
	...
	public String queryByOrganizeSeq(String security,String parameter) {
		...
		try {
	        ...
	        String organizeSeq = String.valueOf(mapParameter.get("organizeSeq"));
	        //3.调用业务
			List<InsCompany> insCompanies = iNetInsCompany.queryByOrganizeSeq(organizeSeq);
			JSONArray jsonarray = JSONArray.fromObject(insCompanies);
			result.put("insCompanies", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
