...
public class VmsTemplateAction {
	...
	public String insert(String security,String parameter) {
		...
		try {
	        ...
	        VmsTemplate vmsTemplate =(VmsTemplate)JsonUtil.convertObject(
	        		mapParameter.get("vmsTemplate").toString(),VmsTemplate.class);
	        ...
	        //3.调用业务
			VmsTemplate newVmsTemplate = iNetVmsTemplate.insert(vmsTemplate, mapConfig);
	        result.put("vmsTemplate", JSONObject.fromObject(newVmsTemplate).toString());
	...
	public String update(String security,String parameter) {
		...
		try {
	        ...
	        List<VmsTemplate> vmsTemplates = (List<VmsTemplate>)JsonUtil.convertArray(
					mapParameter.get("vmsParameters").toString(), new VmsTemplate());

	        String strConfig = JSONObject.fromObject(mapParameter.get("config").toString()).toString();
			JSONObject jsonConfig = JSONObject.fromObject(strConfig);
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetVmsTemplate.update(vmsTemplates, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String delete(String security,String parameter) {
		...
		try {
			...
			List<VmsTemplate> vmsTemplates = (List<VmsTemplate>)JsonUtil.convertArray(
					mapParameter.get("vmsTemplates").toString(), new VmsTemplate());

	        String strConfig = JSONObject.fromObject(mapParameter.get("config").toString()).toString();
			JSONObject jsonConfig = JSONObject.fromObject(strConfig);
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetVmsTemplate.delete(vmsTemplates, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryByOrganizeSeq(String security,String parameter) {
		...
		try {
	        ...
	        String templateType = String.valueOf(mapParameter.get("templateType"));
	        //3.调用业务
			List<VmsTemplate> vmsTemplates = iNetVmsTemplate.queryByOrganizeAndType(organizeSeq,templateType);
			JSONArray jsonarray = JSONArray.fromObject(vmsTemplates);
			result.put("vmsTemplates", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
