...
public class VmsNoticeAction {
	...
	public String insert(String security,String parameter) {
		...
		try {
	        ...
	        //3.调用业务
			VmsNotice newVmsNotice = iNetVmsNotice.insert(vmsNotice, mapConfig);
	        result.put("vmsNotice", JSONObject.fromObject(newVmsNotice).toString());
	...
	public String update(String security,String parameter) {
		...
		try {
			...
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetVmsNotice.update(vmsNotice, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String delete(String security,String parameter) {
		...
		try {
			...
			List<VmsNotice> vmsNotices = (List<VmsNotice>)JsonUtil.convertArray(
					mapParameter.get("vmsNotices").toString(), new VmsNotice());

	        String strConfig = JSONObject.fromObject(mapParameter.get("config").toString()).toString();
			JSONObject jsonConfig = JSONObject.fromObject(strConfig);
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetVmsNotice.delete(vmsNotices, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryByPK(String security,String parameter) {
		...
		try {
	        ...
	        //3.调用业务
	        List<VmsNotice> vmsNotices = iNetVmsNotice.queryByPK(noticeSeq);
			JSONArray jsonarray = JSONArray.fromObject(vmsNotices);
			result.put("vmsNotices", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	@SuppressWarnings("rawtypes")
	public String queryPageByOrganizeSeq(String security,String parameter) {
		Map<String, String> result = new HashMap<String, String>();
		result.put("ResultCode", "0");
		result.put("Message", "操作成功");
		try {
	        ...
	        //3.调用业务
	        List<VmsNotice> vmsNotices = iNetVmsNotice.queryPageByOrganizeSeq(organizeSeq,start,limit);
			JSONArray jsonarray = JSONArray.fromObject(vmsNotices);
			result.put("vmsNotices", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryByOrganizeSeq(String security,String parameter) {
		...
		try {
	        ...
	        String organizeSeq = String.valueOf(mapParameter.get("organizeSeq"));
	        //3.调用业务
	        List<VmsNotice> vmsNotices = iNetVmsNotice.queryByOrganizeSeq(organizeSeq);
			JSONArray jsonarray = JSONArray.fromObject(vmsNotices);
			result.put("vmsNotices", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	@SuppressWarnings("rawtypes")
	public String queryCountByOrganizeSeq(String security,String parameter) {
		Map<String, String> result = new HashMap<String, String>();
		result.put("ResultCode", "0");
		result.put("Message", "操作成功");
		try {
	        ...
	        String organizeSeq = String.valueOf(mapParameter.get("organizeSeq"));
	        //3.调用业务
	        int count = iNetVmsNotice.queryCountByOrganizeSeq(
	        		organizeSeq);
	...
	public String queryPageByCustom(String security,String parameter) {
		...
		try {
	        ...
	        Map mapParameter = (Map)jsonParameter;
	        String organizeSeq = String.valueOf(mapParameter.get("organizeSeq"));
	        String noticeName = String.valueOf(mapParameter.get("noticeName"));
	        String noticeStatus = String.valueOf(mapParameter.get("noticeStatus"));
	        int start = Integer.valueOf(mapParameter.get("start").toString());
	        int limit = Integer.valueOf(mapParameter.get("limit").toString());
	        //3.调用业务
	        List<VmsNotice> vmsNotices = iNetVmsNotice.queryPageByCustom(
	        		organizeSeq, noticeName, noticeStatus, start, limit);
			JSONArray jsonarray = JSONArray.fromObject(vmsNotices);
			result.put("vmsNotices", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryAllByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String noticeStatus = String.valueOf(mapParameter.get("noticeStatus"));
	        //3.调用业务
	        List<VmsNotice> vmsNotices = iNetVmsNotice.queryAllByCustom(
	        		organizeSeq, noticeName, noticeStatus);
			JSONArray jsonarray = JSONArray.fromObject(vmsNotices);
			result.put("vmsNotices", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	public String queryCountByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String noticeStatus = String.valueOf(mapParameter.get("noticeStatus"));
	        //3.调用业务
	        int count = iNetVmsNotice.queryCountByCustom(
	        		organizeSeq, noticeName, noticeStatus);
			result.put("count", String.valueOf(count));
		} catch (UserBusinessException e) {
			e.printStackTrace();
	...
	@SuppressWarnings("rawtypes")
	public String queryByStatusAndTime(String security,String parameter) {
		Map<String, String> result = new HashMap<String, String>();
		result.put("ResultCode", "0");
		result.put("Message", "操作成功");
		try {
	        ...
	        String organizeSeq = String.valueOf(mapParameter.get("organizeSeq"));
	        String noticeStatus = String.valueOf(mapParameter.get("noticeStatus"));
	        String currTime = String.valueOf(mapParameter.get("currTime"));
	        //3.调用业务
	        List<VmsNotice> vmsNotices =iNetVmsNotice.queryByStatusAndTime(
	        		organizeSeq, noticeStatus, currTime);
	        JSONArray jsonarray = JSONArray.fromObject(vmsNotices);
			result.put("vmsNotices", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
