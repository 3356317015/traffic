...
public class SamTableseqAction {
	...
	public String insert(String security,String parameter) {
		...
		try {
	        ...
	        SamTableseq samTableseq =(SamTableseq)JsonUtil.convertObject(
	        		mapParameter.get("samTableseq").toString(),SamTableseq.class);
			...
			System.out.println("samTableseq"+samTableseq.getOrganizeSeq());
	        
	        //3.调用业务
			SamTableseq newSamTableseq = iNetSamTableseq.insert(samTableseq,mapConfig);
	        result.put("samTableseq", JSONObject.fromObject(newSamTableseq).toString());
	...
	public String update(String security,String parameter) {
		...
		try {
	        ...
	        //3.调用业务
			iNetSamTableseq.update(samTableseq, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String delete(String security,String parameter) {
		...
		try {
			...
			List<SamTableseq> samTableseqs = (List<SamTableseq>)JsonUtil.convertArray(
					mapParameter.get("samTableseqs").toString(), new SamTableseq());

	        String strConfig = JSONObject.fromObject(mapParameter.get("config").toString()).toString();
			JSONObject jsonConfig = JSONObject.fromObject(strConfig);
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetSamTableseq.delete(samTableseqs, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryByPk(String security,String parameter) {
		...
		try {
	        ...
	        String tableName = String.valueOf(mapParameter.get("tableName"));
	        
	        //3.调用业务
			SamTableseq samTableseq = iNetSamTableseq.queryByPk(organizeSeq,tableName);
			result.put("samTableseq", JSONObject.fromObject(samTableseq).toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryPageByCustom(String security,String parameter) {
		...
		try {
	        ...
	        //3.调用业务
			List<SamTableseq> samTableseqs = iNetSamTableseq.queryPageByCustom(organizeSeq,start,limit);
			JSONArray jsonarray = JSONArray.fromObject(samTableseqs);
			result.put("samTableseqs", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String queryCountByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String organizeSeq = String.valueOf(mapParameter.get("organizeSeq"));
	        //3.调用业务
			int count = iNetSamTableseq.queryCountByCustom(organizeSeq);
	...
	public String queryAllByCustom(String security,String parameter) {
		...
		try {
	        ...
	        String organizeSeq = String.valueOf(mapParameter.get("organizeSeq"));
	        //3.调用业务
			List<SamTableseq> samTableseqs = iNetSamTableseq.queryAllByCustom(organizeSeq);
			JSONArray jsonarray = JSONArray.fromObject(samTableseqs);
			result.put("samTableseqs", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
