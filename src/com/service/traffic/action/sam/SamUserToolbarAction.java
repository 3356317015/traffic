 ...
 * @author lcy
 */
public class SamUserToolbarAction {
	...
	public String insert(String security,String parameter) {
		...
		try {
	        ...
	        SamUserToolbar samUserToolbar =(SamUserToolbar)JsonUtil.convertObject(
	        		mapParameter.get("samUserToolbar").toString(),SamUserToolbar.class);
	        ...
	        //3.调用业务
			SamUserToolbar newSamUserToolbar = iNetSamUserToolbar.insert(userSeq,samUserToolbar, mapConfig);
			result.put("samUserToolbar", JSONObject.fromObject(newSamUserToolbar).toString());
	...
	public String update(String security,String parameter) {
		...
		try {
			...
			Map mapConfig = (Map)jsonConfig;
	        //3.调用业务
			iNetSamUserToolbar.update(samUserToolbar, mapConfig);
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
	...
	public String deleteByPk(String security,String parameter) {
		...
		try {
	        ...
	        String toolBarSeq = mapParameter.get("samUserToolbar").toString();
	...
	@SuppressWarnings("rawtypes")
	public String deleteByUserSeq(String security,String parameter) {
		Map<String, String> result = new HashMap<String, String>();
		result.put("ResultCode", "0");
		result.put("Message", "操作成功");
		try {
	        ...
	        String moduleSeq = mapParameter.get("moduleSeq").toString();
	        String userSeq = mapParameter.get("userSeq").toString();
	        //3.调用业务
	...
	public String queryByUserSeq(String security,String parameter) {
		...
		try {
	        ...
	        String moduleSeq = String.valueOf(mapParameter.get("moduleSeq"));
	        //3.调用业务
			List<SamUserToolbar> samUserToolbars = iNetSamUserToolbar.queryByUserSeq(
					userSeq,moduleSeq);
			JSONArray jsonarray = JSONArray.fromObject(samUserToolbars);
			result.put("samUserToolbars", jsonarray.toString());
		} catch (UserBusinessException e) {
			e.printStackTrace();
			result.put("ResultCode", "1");
			result.put("Message", e.getMessage());
