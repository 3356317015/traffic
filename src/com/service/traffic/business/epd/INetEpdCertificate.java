...
public interface INetEpdCertificate {
	...
	public List<EpdCertificate> queryAllByCustom(String organizeSeq, String cerType, String cerName, String cerStatus) throws UserBusinessException;

	public int queryCountByCustom(String organizeSeq, String cerType, String cerName, String cerStatus) throws UserBusinessException;
