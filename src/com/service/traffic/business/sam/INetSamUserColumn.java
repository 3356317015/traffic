 ...
 * @author lcy
 */
public interface INetSamUserColumn {
	 ...
	 * @throws UserBusinessException
	 */
	public List<GridColumn> queryByGridColumn(List<GridColumn> columns,String className,String gridName,
			String userSeq) throws UserBusinessException;
	 ...
	 * @throws UserBusinessException void
	 */
	public void deleteByUserGrid(String className, String gridName, String userSeq,
