...
/**
 * INetSamService概要说明：销售点接口
 * @author lcy
 */
public interface INetSamService {
	...
	public List<SamService> queryAllByCustom(String organizeSeq,String serviceCode,String serviceName,
			String serviceStatus) throws UserBusinessException;
	
	public int queryCountByCustom(String organizeSeq,String serviceCode,String serviceName,
			String serviceStatus) throws UserBusinessException;
