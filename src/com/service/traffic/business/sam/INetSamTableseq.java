...
public interface INetSamTableseq {
	 ...
	 * @throws UserBusinessException
	 */
	public SamTableseq queryByPk(String orgainzeSeq, String tableName) throws UserBusinessException;
	 ...
	 * @throws UserBusinessException
	 */
	public List<SamTableseq> queryPageByCustom(String orgainzeSeq, int start,int limit) throws UserBusinessException;
