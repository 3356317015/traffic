...
public interface INetVmsNotice {
	...
	public int queryCountByOrganizeSeq(String organizeSeq) throws UserBusinessException;
	...
	public List<VmsNotice> queryByStatusAndTime(String organizeSeq,String noticeStatus,
			String currTime) throws UserBusinessException;
